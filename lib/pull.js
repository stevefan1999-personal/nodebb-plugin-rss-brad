...
var turndownService = new TurndownService({
    // This option prevents TurndownService from escaping Markdown characters
    escape: false,
});

// Add or modify rules for handling specific elements
turndownService.addRule('paragraphs', {
    filter: 'p',
    replacement: function(content) {
        // This ensures a double line break after each paragraph
        return '\n\n' + content + '\n\n';
    }
});
